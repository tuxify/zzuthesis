...
%% Last modified: 2019-10-31 13:12
%%================================================
% \newgeometry{left=2cm,top=2cm,bottom=2cm,right=2cm,includefoot}
\chapter{表格附件}
\addcontentsline{toc}{section}{附表~1：毕业设计（论文）任务书}
\begin{center}
  \sffamily\sanhao[1] 毕业设计（论文）任务书
\end{center}
% \vspace*{.5ex}
% \begin{center}
